...
# Method 2: pez_count
# Input: None
# Output: Returns the number of pez currently in the pez dispenser

# Method 3: see_all_pez
# Input: None
# Output: An array of all the current flavors in the pez dispenser

# Method 4: add_pez
# Input: Accepts an input new_pez
